...
<div class="orange text-center banner"><h1 class="white-text-md"> Hear from our Graduates</h1></div>
<div class="container">
<?php 
    /*
        Configuration.
    ...
    */
    ...
    $place_ID       = 'ChIJExw4_Vw1hFQRXhxpuYDNR_w'; // Get from: https://developers.google.com/places/place-id
    $business_type  = 'ProfessionalService'; // Example: FinancialService (http://schema.org)
    $business_name  = 'Academy of Learning Career College';
    $street_address = '204-2692 Clearbrook Rd';
...
<div id="google-reviews" class="row"></div>
