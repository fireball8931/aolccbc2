<?php 
    ...
    */
    ...
    $place_ID       = 'ChIJ936qHC3OhVQRqs19jkUjttg'; // Get from: https://developers.google.com/places/place-id
    ...
    $street_address = '201-20621 Logan Ave';
    $locality       = 'Langley'; // Example: Docklands (http://schema.org/addressLocality)
    $region         = 'BC';
    $post_code      = 'V3A 7R3';
